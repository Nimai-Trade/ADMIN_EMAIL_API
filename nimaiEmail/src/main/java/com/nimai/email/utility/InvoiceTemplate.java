...
import com.nimai.email.utility.AmountToWords;
...
public class InvoiceTemplate {
  private static Logger logger = LoggerFactory.getLogger(com.nimai.email.utility.InvoiceTemplate.class);
  ...
  public <T> byte[] generateSplanInvoiceTemplatePdf(NimaiSubscriptionDetails subscriptionDetails, OnlinePayment paymentDetails, NimaiSystemConfig configDetails2, String imagePath) {
    ...
    if (subscriptionDetails.getVasAmount() == 0 && subscriptionDetails.getDiscount().doubleValue() == 0.0D && subscriptionDetails
      .getSubscriptionAmount() != 0) {
      logger.info("===============first condition=================");
      toalAmount = String.valueOf(subscriptionDetails.getSubscriptionAmount());
      calculatedgstValue = String.valueOf(this.util
          .GstValue(subscriptionDetails.getSubscriptionAmount(), configDetails2.getSystemEntityValue()));
    } else if (subscriptionDetails.getVasAmount() != 0 && subscriptionDetails.getDiscount().doubleValue() == 0.0D && subscriptionDetails
      .getSubscriptionAmount() != 0) {
      logger.info("===============second condition=================");
      Double vasPlusSPlan = Double.valueOf((subscriptionDetails.getVasAmount() + subscriptionDetails.getSubscriptionAmount()));
      toalAmount = String.valueOf(vasPlusSPlan);
      calculatedgstValue = String.valueOf(this.util.GstValue(vasPlusSPlan.doubleValue(), configDetails2.getSystemEntityValue()));
      System.out.println("===============second condition=================" + vasPlusSPlan);
    } else if (subscriptionDetails.getVasAmount() != 0 && subscriptionDetails.getDiscount().doubleValue() != 0.0D && subscriptionDetails
      .getSubscriptionAmount() != 0) {
      Double vasPlusSPlan = Double.valueOf((subscriptionDetails.getVasAmount() + subscriptionDetails.getSubscriptionAmount()) - subscriptionDetails
      ...
      .getSubscriptionAmount() != 0) {
      Double vasPlusSPlan = Double.valueOf(subscriptionDetails.getSubscriptionAmount() - subscriptionDetails.getDiscount().doubleValue());
      toalAmount = String.valueOf(vasPlusSPlan);
      calculatedgstValue = String.valueOf(this.util.GstValue(vasPlusSPlan.doubleValue(), configDetails2.getSystemEntityValue()));
    ...
    String invoiceFooter = getInvoiceFooter(subscriptionDetails, granTotal, gst, calculatedgstValue, toalAmount, totalAmountInwords);
    try {
      logger.info("====================+++++++htmInvoicePath" + this.htmInvoicePath);
      File file = new File(this.htmInvoicePath + date + "\\" + invoiceName + ".pdf");
      String pdfPath = this.pdfLocation + "\\" + subscriptionDetails.getUserid().getUserid() + "_" + subscriptionDetails.getSubscriptionId() + ".pdf";
      String DocpdfPath = this.pdfLocation + "\\" + subscriptionDetails.getUserid().getUserid() + "_" + subscriptionDetails.getSubscriptionId() + ".docx";
      ...
      logger.info("===========================generateSplanInvoiceTemplate:-=======================================");
      return null;
    } 
  }
  
  public InvoiceBeanResponse genStringSplanInvoiceTemplatePdf(NimaiSubscriptionDetails subscriptionDetails, OnlinePayment paymentDetails, NimaiSystemConfig configDetails2, String imagePath, NimaiSubscriptionVas vasDetails) {
    System.out.println("Inside generateSplanInvoiceTemplategenerateSplanInvoiceTemplate " + subscriptionDetails);
    String invoiceName = subscriptionDetails.getSubscriptionId() + ".htm";
    String pattern = "MM/dd/yyyy";
    Date dnow = new Date();
    ...
    if (subscriptionDetails.getVasAmount() == 0 && subscriptionDetails.getDiscount().doubleValue() == 0.0D && subscriptionDetails
      ...
      logger.info("===============second condition=================");
      if (vasDetails == null) {
        vasPlusSPlan = Double.valueOf((subscriptionDetails.getVasAmount() + subscriptionDetails.getSubscriptionAmount()));
        toalAmount = String.valueOf(vasPlusSPlan);
        calculatedgstValue = String.valueOf(this.util.GstValue(vasPlusSPlan.doubleValue(), configDetails2.getSystemEntityValue()));
      ...
      Double vasPlusSPlan;
      if (vasDetails == null) {
        vasPlusSPlan = Double.valueOf((subscriptionDetails.getVasAmount() + subscriptionDetails.getSubscriptionAmount()) - subscriptionDetails
            .getDiscount().doubleValue());
        toalAmount = String.valueOf(vasPlusSPlan);
        calculatedgstValue = String.valueOf(this.util.GstValue(vasPlusSPlan.doubleValue(), configDetails2.getSystemEntityValue()));
      } else if (vasDetails.getSplanVasFlag() == 0) {
        vasPlusSPlan = Double.valueOf((0 + subscriptionDetails.getSubscriptionAmount()) - subscriptionDetails
            .getDiscount().doubleValue());
        toalAmount = String.valueOf(vasPlusSPlan);
        calculatedgstValue = String.valueOf(this.util.GstValue(vasPlusSPlan.doubleValue(), configDetails2.getSystemEntityValue()));
      } else {
    ...
    try {
      ...
      beanResponse.setContactPersonName(subscriptionDetails.getUserid().getFirstName() + " " + subscriptionDetails
      ...
      if (vasDetails == null) {
        ...
        beanResponse.setVasDiscount(
            String.valueOf(Double.parseDouble((new DecimalFormat("##.##")).format(subscriptionDetails.getDiscount()))));
        ...
        beanResponse.setVasDiscount(
            String.valueOf(Double.parseDouble((new DecimalFormat("##.##")).format(0.0D))));
      ...
      e.printStackTrace();
      logger.info("============Inside generateSplanInvoiceTemplate class==========");
      logger.info("===========================generateSplanInvoiceTemplate:-=========================S==============");
      return null;
    } 
  }
  
  public String generateSplanInvoiceTemplate(NimaiSubscriptionDetails subscriptionDetails, OnlinePayment paymentDetails, NimaiSystemConfig configDetails2, String imagePath) {
    System.out.println("Inside generateSplanInvoiceTemplategenerateSplanInvoiceTemplate " + subscriptionDetails);
    String invoiceName = subscriptionDetails.getSubscriptionId() + ".htm";
    String pattern = "MM/dd/yyyy";
    Date dnow = new Date();
    ...
    try {
      ...
      String pdfPath = subscriptionDetails.getUserid().getUserid() + "_" + subscriptionDetails.getSubscriptionId() + ".pdf";
      file.getParentFile().mkdirs();
      FileWriter writer = new FileWriter(file);
      BufferedWriter bw = new BufferedWriter(new FileWriter(file));
      bw.write(invoiceHeader + invoiceSubscription + invoiceVas + invoiceDiscount + invoiceFooter);
  ...
  private String getInvoiceDiscount(NimaiSubscriptionDetails subscriptionDetails, String srNummber) {
    String discount = "                     <tr> \r\n                        <td style=\"text-align: center;padding:5px;vertical-align:top;border-bottom:1px dashed #ccc;border-left: 1px dashed #ccc;color: #ed7d31;font-weight: 600;height: 22px;\">\r\n                         " + srNummber + "\r\n                        </td> \r\n                        <td style=\"padding:5px;vertical-align:top;border-bottom:1px dashed #ccc;border-left: 1px dashed #ccc;color: #ed7d31;\"> \r\n                           <i>Discount Coupon</i>\r\n                        </td> \r\n                        <td style=\"padding:5px;vertical-align:top;border-bottom:1px dashed #ccc;border-left: 1px dashed #ccc;\"> \r\n                           <i>" + String.valueOf(
        Double.parseDouble((new DecimalFormat("##.##")).format(subscriptionDetails.getDiscount()))) + "</i>\r\n                        </td>\r\n                     </tr> \r\n                     <tr> \r\n                        <td style=\"padding:5px;vertical-align:top;border-bottom:1px dashed #ccc;border-left: 1px dashed #ccc;color: black;font-weight: 600;height: 22px;\">\r\n                           \r\n                        </td> \r\n                        <td style=\"padding:5px;vertical-align:top;border-bottom:1px dashed #ccc;border-left: 1px dashed #ccc;color:black;\"> \r\n                        </td> \r\n                        <td style=\"padding:5px;vertical-align:top;border-bottom:1px dashed #ccc;border-left: 1px dashed #ccc;\"> \r\n                        </td>\r\n                     </tr> \r\n";
    return discount;
  }
  
  public String generateVasInvoiceTemplate(NimaiSubscriptionVas vasDetails, NimaiSubscriptionDetails subDetails, OnlinePayment paymentDetails, NimaiSystemConfig configDetails, String imagePath) {
    ...
    String invoiceFooter = getVasInvoiceFooter(subDetails, toalAmount, gst, calculatedgstValue, granTotal, totalAmountInwords);
    try {
  ...
  public InvoiceBeanResponse generateVasInvoiceResponse(NimaiSubscriptionVas vasDetails, NimaiSubscriptionDetails subDetails, OnlinePayment paymentDetails, NimaiSystemConfig configDetails) {
    logger.info("Inside generateSplanInvoiceTemplategenerateSplanInvoiceTemplate " + vasDetails);
    String invoiceName = vasDetails.getId() + vasDetails.getSubscriptionId() + vasDetails.getVasId() + ".htm";
    String pattern = "MM/dd/yyyy";
    Date dnow = new Date();
  ...
  public String downloadVasInvoiceTemplate(NimaiSubscriptionVas vasDetails, NimaiSubscriptionDetails subDetails, OnlinePayment paymentDetails, NimaiSystemConfig configDetails, String imagePath) {
    logger.info("Inside generateSplanInvoiceTemplategenerateSplanInvoiceTemplate " + vasDetails);
    String invoiceName = vasDetails.getId() + vasDetails.getSubscriptionId() + vasDetails.getVasId() + ".htm";
    String pattern = "MM/dd/yyyy";
    Date dnow = new Date();
  ...
  private String getVasInvoiceHeader(NimaiSubscriptionDetails subDetails, String date, String referenceNumber, NimaiSubscriptionVas vasDetails, String imagePath) {
    String invoiceNumber = "";
  ...
  private String getVasInvoiceFooter(NimaiSubscriptionDetails subscriptionDetails, String granTotal, String gst, String calculatedgstValue, String toalAmountWithGst, String totalAmountInwords) {

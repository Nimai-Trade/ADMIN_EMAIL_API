...
@NamedQueries({ @NamedQuery(name = "NimaiMQuotation.findAll", query = "SELECT n FROM NimaiMQuotation n") })
public class NimaiMQuotation implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.quotationId == null && other.quotationId != null)
				|| (this.quotationId != null && !this.quotationId.equals(other.quotationId))) {
			return false;
		}
		return true;
	}
